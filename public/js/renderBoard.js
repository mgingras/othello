...
buf.push("<p style=\"position:absolute;top:0;right:15px;font-size:10px;\">" + (jade.escape(null == (jade_interp = turn) ? "" : jade_interp)));
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</p>");
jade_debug.shift();
